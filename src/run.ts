...
export async function run (argv: string[]) {
	...
	program
		...
		.option(`--data <path>`, `Path of the Source Data. Defaults to '${defaultConfig.data}'.`)
		.option(`--jsonIterationDepth <integer>`, `Depth of JSON Data Reference Searching. Defaults to '${defaultConfig.jsonIterationDepth}'.`)
